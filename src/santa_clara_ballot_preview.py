#!/usr/bin/env python3
"""
Santa Clara County ballot preview for the June 2, 2026 Primary Election.

Candidate data: https://files.santaclaracounty.gov/exjcpb1296/2026-04/qualified-list-local-on-ballot-rad-3.13.2026-v3.pdf
Measure data:   https://vote.santaclaracounty.gov/list-local-measures-3
...
OUTPUT_FILE = _ROOT / "data" / "santa_clara_ballot_preview_2026-06-02.html"

COUNTY = "Santa Clara"
ELECTION_TITLE = "Santa Clara County — June 2, 2026 Primary"
