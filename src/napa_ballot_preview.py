#!/usr/bin/env python3
"""
Napa County ballot preview for the June 2, 2026 Primary Election.

Data source: Qualified List of Candidates PDF from napacounty.gov
All candidates are uncontested; data stored in uncontested_races.csv.
...
OUTPUT_FILE = _ROOT / "data" / "napa_ballot_preview_2026-06-02.html"

COUNTY = "Napa"
ELECTION_TITLE = "Napa County — June 2, 2026 Primary"
...
def main():
    ...
    print(f"Loaded {len(races)} contested races, {len(measures)} measures, {len(uncontested)} uncontested")
